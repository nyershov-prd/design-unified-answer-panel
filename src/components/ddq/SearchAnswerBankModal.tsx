        ...
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border-2 border-purple-300 rounded-lg focus:outline-none focus:border-purple-500 text-sm"
            />
          </div>
          ...
          <div className="flex items-center gap-3 mt-3">
            ...
            <div className="px-3 py-1.5 text-xs bg-gray-50 text-gray-600 border border-gray-200 rounded-md">
              Source: DDQ
            </div>
            <div className="px-3 py-1.5 text-xs bg-gray-50 text-gray-600 border border-gray-200 rounded-md">
              Year: 2024+
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredAnswers.map((answer) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="text-sm font-medium text-gray-900">{answer.question}</div>
                  ...
                  <td className="px-4 py-3 text-sm text-gray-600">{answer.lastUsed}</td>
                </tr>
              ))}
            </tbody>
          </table>
